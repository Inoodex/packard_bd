...
<head>
    ...
    <meta name="twitter:title" content="InoodexInventory">
    ...
    <meta property="og:title" content="InoodexInventory">
...
<body>
                    ...
                    <div class="login-right">
                        <div class="login-right-wrap">
                            ...
                            <form method="post" action="{{ route('login') }}">
                                ...
                                <!-- /Social Login -->
                                <div class="text-center dont-have d-none">Don't have an account yet? <a
    ...
    <script src="{{ asset('assets') }}/js/rocket-loader.min.js" data-cf-settings="77dbd93abd5e1f6e650e73bc-|49" defer>
    </script>
</body>
